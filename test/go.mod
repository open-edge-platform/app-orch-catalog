...
require (
	...
	github.com/open-edge-platform/app-orch-deployment/app-service-proxy v1.4.6 // indirect
	github.com/open-edge-platform/app-orch-deployment/test-common-utils v0.0.0-20250613084623-8b8f3afdadff // indirect
