...
var (
	...
	generateDefaultParameters bool
...
func mainCommand(cmd *cobra.Command, args []string) {
	...
	err = dp.GenerateDeploymentPackage(helm, valuesFile, outputDir, namespace, includeAuth, generateDefaultValues, generateDefaultParameters)
	verboseerror.FatalErrCheck(err)
}
...
func main() {
	...
	rootCmd.PersistentFlags().BoolVarP(&generateDefaultValues, "generate-default-values", "D", false, "generate default profile values from the chart's values.yaml file")
	rootCmd.PersistentFlags().BoolVarP(&generateDefaultParameters, "generate-default-parameters", "P", false, "generate default parameters from the profile values")
