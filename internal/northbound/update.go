...
func (g *Server) createOrUpdateRegistry(ctx context.Context, tx *generated.Tx, projectUUID string, reg *catalogv3.Registry, registryEvents *RegistryEvents, allowOverwrite bool) error {
	...
	if err != nil {
		...
		if !allowOverwrite {
			// Registries are often shared between multiple applicaitons, and there are significant negative
			// consequebnces to overwriting an existing registry, especially if it is oci-harbor-helm or
